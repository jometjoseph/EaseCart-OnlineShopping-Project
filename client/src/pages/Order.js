...
function Order() {
  ...
  const getOrderingItems = () => {
    try {
      axios.get("https://localhost:7258/api/Cart/UserCart").then((res) => {
      ...
      if (!res) {
        ...
        try {
          buyNow.forEach((item, index) => {
            ...
            try {
              axios
                .post("https://localhost:7258/api/Order/userOrders", data)
                .then((res) => {
                  console.log("Item ordered successfully", res);
                  try {
                    axios
                      .delete(`https://localhost:7258/api/Cart/${item.id}`)
                      .then((res) => {
                              ...
                              <div className="card-body">
                                <div className="d-flex justify-content-between">
                                  <div className="d-flex flex-row align-items-center">
                                    ...
                                    <div className="ms-3">
                                      <h5>{item.product.name}</h5>type of status{" "}
                                      {typeof item.status}
                                    ...
                                    <div className="" style={{ width: "50px" }}>
                                      ...
                                      >
                                        <input
                                          ...
                                          type="number"
                                          id="typeNumber"
                                          defaultValue={quantityValues[index]}
