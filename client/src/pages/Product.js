    ...
    <div className="row gx-5">
      <aside className="col-lg-6">
        <div className="border rounded-4 mb-3 d-flex justify-content-center">
          <a data-fslightbox="mygalley" className="rounded-4" target="" data-type="image" href="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/items/detail1/big.webp">
            <img style={{maxWidth: "100%", maxHeight: "90vh", margin: "auto"}} className="rounded-4 fit" src={product.imageUrl} alt="" />
          </a>
        </div>
      </aside>
      <main className="col-lg-6">
        <div className="ps-lg-3">
          ...
          <div className="d-flex flex-row my-3">
            ...
            <span className="text-muted"><i className="fas fa-shopping-basket fa-sm mx-1"></i>{product.quantity} orders</span>
         ...
         {/* {product.categoryId} */}
          ...
          <a href="#c" className="btn btn-primary shadow-0"> <i className="me-1 fa fa-shopping-basket"></i> Add to cart </a>
          <button type='button'  onClick={backToHome} className="btn btn-light border border-secondary py-2 icon-hover px-3">  Back to Home </button>
        </div>
      </main>
    </div>
  </div>
